...
import styles from "./PopupLoseMedium.module.css";
const PopupLoseMedium = ({ onClose }) => {
  ...
  return (
    <div className={styles.popuplosemedium}>
...
export default PopupLoseMedium;
